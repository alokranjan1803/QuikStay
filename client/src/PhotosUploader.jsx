...
export default function PhotosUploader({addedPhotos,onChange}) {
  ...
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    try {
      const { data: filename } = await axios.post(`hotel-mingle-api.vercel.app/upload-by-link`, { link: photoLink });
      onChange(prev => {
  ...
  function uploadPhoto(ev) {
    ...
    axios.post(`hotel-mingle-api.vercel.app/upload`, data, {
    ...
    <>
      ...
      <div className="mt-2 grid gap-3 grid-cols-3 lg:grid-cols-8 md:grid-cols-5">
            ...
            <div className="h-32 flex relative" key={link}>
                <img className="rounded-2xl w-full object-cover" src={'hotel-mingle-api.vercel.app/uploads/'+link} alt=""/>
