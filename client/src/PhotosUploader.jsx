...
export default function PhotosUploader({addedPhotos,onChange}) {
  ...
  async function addPhotoByLink(ev) {
    ev.preventDefault();
    try {
      const { data: filename } = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/upload-by-link`, { link: photoLink });
      onChange(prev => {
    ...
    <>
      ...
      <div className="mt-2 grid gap-3 grid-cols-3 lg:grid-cols-8 md:grid-cols-5">
            ...
            <div className="h-32 flex relative" key={link}>
                <img className="rounded-2xl w-full object-cover" src={`${import.meta.env.VITE_API_BASE_URL}/uploads/`+link} alt=""/>
